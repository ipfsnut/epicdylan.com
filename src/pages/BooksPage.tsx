...
export const BooksPage: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <p className="text-xl text-warm-text-secondary mb-12">
      ...
      <div className="space-y-8">
        <div className="bg-white rounded-xl p-8 border border-warm-border">
          <div className="flex flex-col sm:flex-row items-start gap-6">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold font-display text-warm-text mb-2">INEVITABLE: Distributed Cognition & Network Superintelligence</h2>
              ...
              <div className="flex gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-warm-text-secondary hover:bg-warm-text text-white rounded-lg transition-colors"
                >
                  Amazon
                  <ExternalLink className="w-4 h-4" />
                </a>
        ...
        <div className="bg-white rounded-xl p-8 border border-warm-border">
          <div className="flex flex-col sm:flex-row items-start gap-6">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold font-display text-warm-text mb-2">Formal Dialectics</h2>
              <p className="text-warm-text-secondary mb-4">
